    ...
    return (
        <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            <HomeCard
                ...
                handleClick={async () => setMeetingState('isInstantMeeting')}
            ...
            <HomeCard
                ...
                handleClick={async () => setMeetingState('isScheduleMeeting')}
                className="bg-blue-1"
            />
            ...
            <HomeCard
                ...
                handleClick={async () => setMeetingState('isJoiningMeeting')}
